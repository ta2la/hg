...
void EntityPack::refresh(void)
{
    ...
    //display_->bitmap_->bmpUpdate(); //DISPLAYFCE
    display_->updateBmp();
...
{
    if (display_ == nullptr) return;
    display_->updateDynamic(); //DISPLAYFCE
...
//=============================================================================
void EntityPack::addDisplay(DisplayBase* display)
{
    assert(display_==nullptr);
    display_ = display; //DISPLAYFCE
    display->entityPack_ = this;
}
