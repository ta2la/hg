...
using namespace T2l;
//=============================================================================
ElexSline::ElexSline( SfeatLineS& sfeat, const T2l::StyleChange* styleChange, bool closed ) :
    ElementEx(sfeat.color(), styleChange),
...
//=============================================================================
void ElexSline::decompose(CanvasI* canvas)
{
    //<STEP>
    bool hasScale = false;
    ...
    while(true) {
        ...
        ElexSymbol rawSymbol( pline.getPoint(parameter), *symbol(),
