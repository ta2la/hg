...
//=============================================================================
class ElexSymbol : public ElementEx {
//=============================================================================
public:
//<CONSTRUCTION>
    ElexSymbol( const Point2F position, Symbol& symbol,
                      const Color& color, AngleXcc angle,
                      EAngleZero angleZero = ANGLE_ZERO_COORDS,
                      const StyleChange* styleChange = nullptr, double height = 1.0 );
    virtual ~ElexSymbol() {}
//<METHODS>
...
//=============================================================================
//<OVERRIDES>
    virtual ECategory category() { return ELEM_RAW_SYMBOL; }
