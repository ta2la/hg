...
//=============================================================================
class Display : public TcObject, public DisplayBase {
//=============================================================================
public:
//<ENUM>
    enum EEdge {
...
//<DATA>
    ...
    virtual void scaleSet(double scale);
