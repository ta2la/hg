...
//<CONSTRUCTION>
    ...
    static Style* createLineStyle ( const Color& color, double width = 0.25, const char* id = "", ELineStyle lineStyle = LS_SOLID);
    static Style* createLineStyleStr ( const Color& color, double width, const char* line_style, const char* id = "");
    static QStringList lineStyleCol ();
