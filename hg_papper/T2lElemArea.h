...
{
//=============================================================================
class ElemArea : public T2l::Element {
//=============================================================================
public:
//<ENUMS>
//<CONSTRUCTION>
    ElemArea( const Color& color, unsigned char alpha = 255 );
    virtual ~ElemArea(void) {;}
//<NEIGHBOURS>
...
//=============================================================================
//<OVERRIDES>
    ECategory category() final { return ELEM_AREA; }
    void pointAdd(const Point2F& pt, CanvasI& canvas) {
        area().points().points().add(canvas.mapRealToPaper(pt));
    }
protected:
//<DATA>
    Area2          area_;
