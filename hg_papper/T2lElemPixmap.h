...
{
//=============================================================================
class ElemPixmap : public T2l::Element {
//=============================================================================
public:
//<ENUMS>
//<CONSTRUCTION>
    ElemPixmap( const QPixmap* pixmap, const Box2F& pixmapBox, double transparency);
    ElemPixmap( const QImage*  image,  const Rectangle2& imageRect);
    virtual ~ElemPixmap(void) {}
//<METHODS>
...
//=============================================================================
//<OVERRIDES>
    virtual ECategory category() { return ELEM_IMAGE; }
protected:
//<DATA>
