...
public:
//<CONSTRUCTION>
    ElemText( const QString& text, const Point2F& position, double height = 2,
                 const Color& color = Color::BLACK,
                 EPositionH positionH = POSITION_H_LEFT,
                 EPositionV positionV = POSITION_V_TOP,
                 bool bold = false, AngleXcc angle = AngleXcc(0));
    ElemText( const QString& text, CanvasI& canvas, const Point2F& position, double height = 2,
                 const Color& color = Color::BLACK,
                 EPositionH positionH = POSITION_H_LEFT,
                 EPositionV positionV = POSITION_V_TOP,
                 bool bold = false, AngleXcc angle = AngleXcc(0));
    virtual ~ElemText(void) {;}
//<METHODS>
