...
{
//=============================================================================
class Elem2Text : public Element {
//=============================================================================
public:
//<CONSTRUCTION>
    Elem2Text( const QString& text, const Point2F& position, double height = 2,
                 const Color& color = Color::BLACK,
                 EPositionH positionH = POSITION_H_LEFT,
                 EPositionV positionV = POSITION_V_TOP,
                 bool bold = false, AngleXcc angle = AngleXcc(0));
    Elem2Text( const QString& text, CanvasI& canvas, const Point2F& position, double height = 2,
                 const Color& color = Color::BLACK,
                 EPositionH positionH = POSITION_H_LEFT,
                 EPositionV positionV = POSITION_V_TOP,
                 bool bold = false, AngleXcc angle = AngleXcc(0));
    virtual ~Elem2Text(void) {;}
//<METHODS>
...
//=============================================================================
//<OVERRIDES>
    virtual ECategory category() { return ELEM_TEXT; }
protected:
//<DATA>
    QString     text_;
    Point2F     position_;
